  ...
  return (
    <div className="App">
      ...
      <content className="text-center ">
        <h1 className='mt-32 text-5xl  text-5xl	font-bold mb-[197px]'>Here is what’s happening in <br /> the world of talk business.</h1>
        ...
        <div className='flex align-center justify-center gap-40 font-bold	text-xl mb-[100px]'>
          <div>
